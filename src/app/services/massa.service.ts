...
export class ServicoMassa {
  ...
  iniciar(id: number, dados: DadosDisparoMassa) { return this.http.post<RespostaDisparoMassa>(`/api/importacoes/${id}/enviar`, { templateId: dados.idModelo, templateNome: dados.nomeModelo, mensagem: dados.mensagem, intervaloMs: dados.intervaloMs, instance: dados.instancia }); }
